...
class Shortcode
{
    ...
    public static function generateShortcodeOutput($attributes)
    {
        ...
        $output = '<p>' . __('Determine your current CO₂ emissions, discover savings through alternative means of transport, and see how you compare to others.', 'rrze-green-office') . '</p>
